//RegExp 해도 거의 이해는 x -> 한번 훑어보는 식이 좋음
...
// 연습4. g로 시작하고 d로 끝나는데 그 사이에 o 문자가 2글자 이상인지 비교 (good, goood, goooood)
let regExp5 = /^go{2,}d$/;
...
/*
  ...
  1. 기능 
     ...
     * 전화번호 형식 : 010-숫자4자리-숫자4자리  /^010-\d{4}-\d{4}$/
                                                /^010(-\d{4}){2}$/
  2. 인자
     검사할 전화번호 문자열
  3. 반환
